add-auto-load-safe-path /home/yuchen/sources/go/src/pkg/runtime/runtime-gdb.py

# all-stop mode: when any thread in your program stops,
#                all other threads in the program are also stopped.
#                This is the default mode.
# non-stop mode: other threads can continue to run freely while you
#                examine the stopped thread in the debugger.


# multithread non-stop mode
#set target-async 1
#set pagination off
#set non-stop on
